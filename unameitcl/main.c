 ...
 * 02111-1307, USA.
 */
static char rcsid[] = "$Id: main.c,v 1.13.20.2 1997/09/21 23:43:04 viktor Exp $";
...
/*
 * All the packages that are statically linked against unameitcl should
