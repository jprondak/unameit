...
#
#
# $Id: generator.tcl,v 1.6 1997/03/25 02:44:38 simpson Exp $
#
...
foreach tuple {{server_aliases server_aliases} {networks dump_networks} \
	{canon_hosts canon_hosts} \
	{secondary_ifs secondary_ifs} {host_console host_console} \
        {regions regions} {os os} {pagers pagers}\
	{mailing_lists mailing_lists} {netgroups netgroups}} {
...
#
foreach program [glob [unameit_filename UNAMEIT_BACKEND *.pl]] {
